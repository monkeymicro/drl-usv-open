...
def test(observation_dim: int, action_dim:int, device: str, tcp_socket) -> None:
    ...
    checkpoint = torch.load(f'{HOME}/models/{env_name}/checkpoint.pt', map_location=device, weights_only=False)
...
parser.add_argument('--env_name', type=str, default='CQL-custom')
